...
const TextEditor = ({ insertText, target }) => {
  return (
    <div>
      ...
      <button type="button" className="editor_button" onClick={() => insertText('<div class="ingredients">\n  <div class="ingredient">\n    <div class="ingredient-value">350gr</div>\n    <div class="ingredient-name">white flour</div>\n  </div>\n  <div class="ingredient">\n    <div class="ingredient-value">200ml</div>\n    <div class="ingredient-name">water</div>\n  </div>\n</div>', target)}><strong>Ingredients</strong></button>
      <button type="button" className="editor_button" onClick={() => insertText('<ol class="gradient-list steps">\n\t<li><span>Wash</span></li>\n\t<li><span>Chop</span></li>\n</ol>', target)}><strong>Steps</strong></button>
    </div>
  );
};
